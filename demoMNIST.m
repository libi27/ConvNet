...
lenet = { ...
    ...
    struct('type','input','inInd',0,'outInd',2,'blobSize',[10 100],'fName',trainLabels,'scale',1,'dataType','uint8'), ...
...
% mandatory fields
T = 1000; mu = single(0.9); lam =  single(0.0005); 
learning_rate = @(t)(0.01*(1+0.0001*t)^(-0.75)); % learning rate rule
% optional fields
param.snapshotFile = 'snapshots/snapshot'; param.printIter = 100; param.printDecay = 0.9;  %Changed by Nadav Cohen (23.6.15) - previously: param.snapshotFile = 'snapshot/snapshot'; ...
% call Nesterov
